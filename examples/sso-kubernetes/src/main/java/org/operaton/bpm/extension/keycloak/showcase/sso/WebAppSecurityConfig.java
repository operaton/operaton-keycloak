...
public class WebAppSecurityConfig {
    ...
    public FilterRegistrationBean containerBasedAuthenticationFilter(){
        ...
        filterRegistration.setInitParameters(Collections.singletonMap("authentication-provider", "org.operaton.bpm.extension.keycloak.showcase.sso.KeycloakAuthenticationProvider"));
