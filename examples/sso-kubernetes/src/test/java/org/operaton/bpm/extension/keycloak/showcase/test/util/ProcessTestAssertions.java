package org.operaton.bpm.extension.keycloak.showcase.test.util;
...
public abstract class ProcessTestAssertions {
  ...
  public static class WaitAssert {
    ...
    public WaitAssert hasStartedSubProcess(String processDefinitionKey) {
      waitForAssertion(() -> BpmnAwareTests.assertThat(actual).calledProcessInstance(processDefinitionKey).isActive());
      return this;
    }
  ...
  public static final class JobAssert extends ProcessTestAssertions.WaitAssert {
    ...
    public JobAssert hasRetries(int expectedRetries) {
      waitForAssertion(() -> BpmnAwareTests.assertThat(actual).job(jobActivityId).hasRetries(expectedRetries));
      return this;
    }
  }
