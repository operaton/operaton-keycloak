package org.operaton.bpm.extension.keycloak.json;
...
public final class JsonUtil {
   ...
   * @throws JsonException in case of errors
   */
  public static String parseAsJsonObjectAndGetMemberAsString(String jsonString, String memberName)
   ...
   * @throws JsonException in case of errors
   */
  public static JsonObject findFirst(JsonArray list, String attributeToMatch, String attributeValue)
      throws JsonException {
